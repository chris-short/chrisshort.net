...
![Chris Short in Gopher Form](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/gopherize-me-chris-short.png#center)

I'm many things
But Most Importantly, I'm a **Gopher**

### **Not Too Long Ago in a Place of Work Far, Far Away...**
![Star Wars Scroll Y'all](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/backstory.png#center)
...
### ...
![This Sound Familiar?](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/bill-murray-toaster.gif#center)
...
![This Sound Familiar?](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/2-chainz-tell-em.png#center)
...
### **This is the Goal**
![This is the Goal](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/chrisshort_net-qualys.png#center)
...
### **NBD ... OMG**
![This is the Goal](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/ssl-vendors-suck.png#center)
...
### ...
![Dispicable](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/mj-annoyed.gif#center)
: What do we do?
...
![Go Build by Ashley McNamara](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/go_build.png#center)
...
![Hugging Gophers by Ashley McNamara](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/Hugging_Gophers.png#center)
...
![Gopher Star Wars by Ashley McNamara](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/GOPHER_STAR_WARS.png#center)
...
![Gopher Inclusion by Ashley McNamara](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/GOPHER_INCLUSION.png#center)
...
![Gopher Share by Ashley McNamara](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/GOPHER_SHARE.png#center)
...
![Nuclear Weapons Test](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/nuclear-weapons-test-explosion.jpg#center)
...
### **It's Open Source!**
![ssl-tester on GitHub](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/ssl-tester.png#center)
...
### **It Works!**
![ssl-tester Output](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/ssl-tester-output.png#center)
...
### **No. It Really Works!**
![ssl-tester Output](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/ssltest-ssl-tester-chrisshort-net.png#center)
...
![Gopher Mic Drop by Ashley McNamara](https://c.chrisshort.net/file/chrisshort/testing-certificate-chains-in-go/GOPHER_MIC_DROP.png#center)
