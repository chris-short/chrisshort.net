...
This isn't to say that someone is wrong and I'm right because [Emily Freeman nailed what DevOps is](https://amzn.to/2ImDdLV) and how to go about doing it. It's to say that, I think DevOps is a better way to do business than how it has been done in the past (which is what I think we're all saying) as opposed to it being limited to only IT, in practice. I said it once and I'll say it again:
...
The good news this year is that DevOps has faded a little bit into the background much like how I think Kubernetes will too. It's no longer if you have or haven't picked up some DevOps practices. It's which DevOps practices has an organization started iterating on and how they're being applied. Believe it or not, you're doing some aspects of DevOps whether you realize it or not when using Kubernetes in prod.
